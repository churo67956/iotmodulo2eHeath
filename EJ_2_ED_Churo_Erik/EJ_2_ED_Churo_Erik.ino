...
//Send data
String frame;
eFrame.setDataType("T");//tipo de dato temperatura
eFrame.setTMeasurement(eHealth.getTemperature());//llamada a la api eHealth
eFrame.frameBuilder(&frame);//construimos la trama
mpxbee.writeData(T_PACKAGE_MAX_LENGTH,frame);//enviamos la trama
